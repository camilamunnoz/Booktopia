...
<html lang="es">
  ...
  <head>
    ...
    <!--Aqui se define la configuracion de la pagina-->
  ...
  <body>
    ...
    <!--Este es el menu, aqui se haran los botones tipo iniciar sesion y asi-->
    <!-- Header -->
    <header class="">
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="fisical-catalog.html">Catalogos Fisicos</a>
              </li>
              <li class="nav-item">
